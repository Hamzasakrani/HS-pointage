                                            ...
                                            <div class="modal-dialog">
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        ...
                                                        <h4 class="modal-title">Ajouter pointage</h4>
                                                    </div>
                                                        ...
                                                        <form class="form-horizontal" method="post" role="form"  action="ajouterconge" accept-charset="UTF-8" name="h1">
                                                            ...
                                                            <div class="box-body">
                                                                <div class="form-group">
                                                                    <label for="inputEmail3" class="col-sm-4 control-label">date pointage </label>
                                                                    <div class="col-sm-4">

                                                                        <input type="date"  value="" name="date_">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="box-body">
                                                                <div class="form-group">
                                                                    <label for="inputEmail3" class="col-sm-4 control-label">heur pointage</label>
                                                                    <div class="col-sm-4">
